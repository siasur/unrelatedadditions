...
public class ModItemTagsProvider extends ItemTagsProvider {
    ...
    protected void addTags() {
        ...
        this.tag(ItemTags.CLUSTER_MAX_HARVESTABLES).add(ModItems.WOODEN_HAMMER.get()).add(ModItems.STONE_HAMMER.get()).add(ModItems.IRON_HAMMER.get()).add(ModItems.BRONZE_HAMMER.get()).add(ModItems.GOLDEN_HAMMER.get()).add(ModItems.DIAMOND_HAMMER.get());
